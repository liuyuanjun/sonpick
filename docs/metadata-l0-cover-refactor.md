...
>
> 起始版本：`0.15.0-rc5` → 已落地预发：`0.15.0-rc8`（本轮以 bugfix/行为修正为主，只升 rc）。
>
> 文档状态：设计定稿；**P0 已在 0.15.0-rc6 落地**，`0.15.0-rc7` 修复封面失败误杀标签写穿并补齐错误日志/前端摘要，`0.15.0-rc8` 修复 NAS 出网问题并支持浏览器提交封面字节；P1/P2 可后续迭代。
